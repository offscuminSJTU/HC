...
class PositionEmbeddingCoordsSine(nn.Module):
    ...
    def get_fourier_embeddings(self, xyz, num_channels=None, input_range=None): # input_range = pc_dims
        ...
        if self.normalize:
            xyz = shift_scale_points(xyz, src_range=input_range) # 相当于对geo_dist进行归一化
